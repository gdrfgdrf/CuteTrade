...
class C2SOperationPacket : CustomPayload, PacketAdapter {
    ...
    companion object {
        val CODEC = CustomPayload.codecOf(C2SOperationPacket::write, ::C2SOperationPacket)
        val ID = CustomPayload.Id<C2SOperationPacket>(Constants.C2S_OPERATION)

...
object NetworkManager {
    fun initialize() {
        PayloadTypeRegistry.playS2C().register(S2COperationPacket.ID, S2COperationPacket.CODEC)
        PayloadTypeRegistry.playC2S().register(C2SOperationPacket.ID, C2SOperationPacket.CODEC)
    }
}